...
export function Hero() {
  return (
    <section className="hero-grid relative overflow-hidden animate-fade-in">
      <div className="absolute inset-0 bg-gradient-to-b from-primary/5 via-transparent to-transparent" />
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8">
        <div className="mx-auto max-w-3xl text-center flex flex-col items-center">
          {/* Logo and website title at the mid top of the webpage */}
          <div className="mb-8 flex flex-col items-center gap-3 group cursor-pointer">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-primary-foreground text-primary-foreground text-3xl font-black shadow-xl shadow-primary/20 transition-transform duration-300 group-hover:scale-110">
              C
            </div>
            <span className="font-[family-name:var(--font-plus-jakarta)] text-2xl font-black tracking-tight text-foreground">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row w-full">
            <Button size="lg" variant="accent" asChild className="shadow-md hover:shadow-lg">
              <Link href="/register">
                Get Started Free
